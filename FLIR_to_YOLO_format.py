...
#json_files = "/Users/hayeong/Desktop/파이썬/thermal_annotations.json"
json_files = "/home/strad/OD/FLIR_ADAS_1_3/train/thermal_annotations.json"
...
with open(json_files, 'r') as f:
    ...
    for i in range(0, len(image)):  
        ...
        #file = open('./SV/' + str(img_name) + '.txt', 'w')
        file = open('/home/strad/OD/Yolo_mark/x64/Release/data/img/' + str(img_name) + '.txt', 'w')
